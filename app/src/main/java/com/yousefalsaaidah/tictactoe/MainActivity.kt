...
open class MainActivity : AppCompatActivity() {
    ...
    protected fun buClicked(view: View) {
        ...
        myRef.child("playingOnline").child(sessionID).child(cellId.toString()).setValue(myEmail)
    }
    ...
    protected fun buAcceptEvent(view:View){
        ...
        playingOnline(splitString(userEmail)+splitString(myEmail!!))
        playerSymbol="O"
    ...
    protected fun buRequestEvent(view:View){
        ...
        playingOnline(splitString(myEmail!!)+splitString(userEmail))
        playerSymbol="X"
    ...
    private fun playingOnline(sessionID:String){
        this.sessionID = sessionID
        myRef.child("playingOnline").removeValue()
        myRef.child("playingOnline").child(sessionID)
                        ...
                        try{
                            ...
                            if(td!=null){
                                ...
                                for(key in td.keys){
                                    ...
                                    notifyMe.Notify(applicationContext,value+" want to play with you",number)
                                    number++
